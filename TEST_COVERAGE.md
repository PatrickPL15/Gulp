...
- **Total Tests**: 325 across all suites as of 2026-04-06. 324 passing; 1 known failing: `sen20-embedded-browser` — "scaffolds Chromium session state controls for focus, bounds, visibility, and close" — tracked for resolution.
